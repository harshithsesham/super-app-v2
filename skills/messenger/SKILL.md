...
title: "Messenger"
icon: "messenger"
description: "Work with the user's Messenger account: read and search contacts; read, search, and summarize conversations; send, react to, unsend, or edit messages; and message Marketplace listing threads."
...
| Read, search, summarize, or send from their personal account | **Messenger Companion** | Follow this skill |
...
- Never expose raw tool metadata: IDs (`msg_id`, `message_id`, `mid.$...`,
  `conversation_id`, `cid.$...`, `otid`), device counts, encryption details,
  delivery or receipt state, raw JSON, or cache statistics.
