...
from fresh state. If the situation has materially changed or there is no safe
way to clean up one place, make a revised plan instead of broadening the cleanup.
