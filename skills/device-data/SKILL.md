...
name: "device_data"
title: "Device Data"
description: "Read cached contacts and calendar events when a device is offline or offers no live search."
...
offline, or it does not offer `contacts.search`/`calendar.search`. It never
contacts or mutates a device.
