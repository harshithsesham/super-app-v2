...
`project_dir/.src/validate/` with the `read` tool before responding** (for example,
`~/workspace/your_files/<artifact-slug>/.src/validate/*.png`) and verify: images render, text
