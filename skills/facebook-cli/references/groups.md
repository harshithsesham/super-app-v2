...
Search groups and browse posts in Facebook Groups.
...
- `group_url`: Direct link to the group (e.g. `https://facebook.com/groups/1343933772408499/`)
...
facebook-cli groups posts --group-id 1343933772408499

# Most popular posts
facebook-cli groups posts --group-id 1343933772408499 --sort-by MOST_REACTS --limit 5

# Newest posts first
facebook-cli groups posts --group-id 1343933772408499 --sort-by NEW_POSTS --limit 5

# Search for posts about a topic
facebook-cli groups posts --group-id 1343933772408499 --query "recipe"

# Next page (pass the cursor from the previous response)
facebook-cli groups posts --group-id 1343933772408499 --after "<cursor_from_previous_response>"

# Posts within a time window (Unix seconds)
facebook-cli groups posts --group-id 1343933772408499 --min-timestamp 1750000000 --max-timestamp 1752000000
```
